        ...
        <div class="px-6 h-auto flex sm:block justify-center items-center" style="cursor: auto;">
          <custom-card3>
            <div class="border sm:w-full bg-coolGray-900 text-coolGray-100">
              ...
              <img src="https://source.unsplash.com/TGv4bSO0zcM" alt="" class="border object-cover object-center w-full max-h-lvh sm:h-full bg-coolGray-500" style="cursor: auto;">
            ...
            <div class="px-6 h-auto flex sm:block justify-center items-center" style="cursor: auto;">
              <custom-card3>
                <div class="border sm:w-full bg-coolGray-900 text-coolGray-100">
                  ...
                  <img src="https://source.unsplash.com/4Navv1pBJjU" alt="" class="border object-cover object-center w-full max-h-lvh sm:h-full bg-coolGray-500" style="cursor: auto;">
                  <div class="p-3" style="cursor: auto;">
                    <div class="flex items-center justify-between" style="cursor: auto;">
                      <div class="flex items-center space-x-3">
                        <button type="button" title="Like post" class="flex items-center justify-center">
